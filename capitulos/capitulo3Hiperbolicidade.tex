...
\begin{document}
	...
	\begin{prova}
		...
		\end{aligned}
		\]
		Portanto, $|f^n(x_0) - p| > (1+\epsilon)^n|x_0-p|$, com $n \rightarrow \infty$. Ou seja, como a distância aumenta, esse valor $n$ fará com que $|f^n(x_0) - p| > \alpha$, levando a órbita para fora do intervalo.
	\end{prova}
