...
\begin{document}
	...
	\begin{prova}
		...
		1. Sabemos que $F_\mu$ é conjugada topologicamente a $\sigma$ por $S$ e que $Per(\sigma)$ é denso em $\Sigma_2$. Logo, $Per(\sigma)$ é denso em $\Lambda$.
		
		2. A órbita densa foi provada na Proposição \ref{propriedadesDeSigma}.
		Como existe uma órbita densa para $\sigma$ em $\Sigma_2$ e $\sigma$ é topologicamente transitivo, segue que $F_\mu$ é topologicamente transitiva.
		
		3. A dependência sensível nas condições iniciais foi mostrada no Exemplo $\ref{mapaLogisticoSensivel}$.
	\end{prova}
