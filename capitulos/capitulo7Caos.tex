...
\begin{document}
	...
	\begin{prova}
		...
		Consequentemente, $F_4$ é semi-conjugada a $D$ através da composição $h_2 \circ h_1$. Segue imediatamente que $F_4$ é topologicamente transitiva, pois se $U$ e $V$ são dois intervalos abertos em $I$, podemos escolher arcos abertos $\hat{U}$ e $\hat{V}$ em $S^1$, que se projetam sobre $U$ e $V$ sob $h_2 \circ h_1$. Como existe $k$ tal que $D^k(\hat{U}) \cap \hat{V} \neq \emptyset$, temos, portanto, que $F_4^k(U) \cap V \neq \emptyset$.
		
		Para provar a dependência sensível, notamos que qualquer vizinhança $U$ de $x \in I$ se ``eleva'' a $\hat{U}$ em $S^1$. Existe $n$ tal que $D^n(\hat{U})$ cobre $S^1$, logo $F_4^n(U)$ também cobre $I$. Assim, existem pontos em $U$ que se afastam de $x$ em pelo menos $\delta = 1/2$. 
		
		Finalmente, a densidade de pontos periódicos para $D$ implica que existe um ponto periódico de $D$ em $\hat{U}$. A projeção deste ponto em $U$ é claramente periódica sob $F_4$. \hfill
	\end{prova}
\end{document}	