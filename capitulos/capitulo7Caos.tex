...
\begin{document}
	...
	\begin{definicao}
		$f: J \rightarrow J$ possui dependência sensível às condições iniciais em $J$ se existe $\delta > 0$ tal que, para algum $x\in J$ e uma vizinhança N de $x$, existem $y \in N$ e $n\geq 0$ tal que $|f^(x)-f^n(y)| > \delta$.
	\end{definicao}
