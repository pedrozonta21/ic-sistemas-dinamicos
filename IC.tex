...
Como $f: \mathbb{R} \rightarrow \mathbb{R}$, precisamos garantir $\mu$ tal que a raiz seja real. $1-4\mu \geq 0 \implies \mu \leq \dfrac{1}{4}$.
		...
		\end{itemize}
		Com isso, agora podemos classificar $x_1$ e $x_2$ como atratores ou repulsores quando $\mu < \dfrac{1}{4}$. Para que $x_1$ seja repulsor, deve existir $\mu$ tal que $|f_\mu(x_1)| > 1$
	\end{exemplo}
