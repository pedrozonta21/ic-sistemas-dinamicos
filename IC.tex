...
\begin{document} 
	...
	\begin{exemplo}
		Considere a função $f(x) = -\dfrac{x^3}{2}-\dfrac{x}{2}$ com derivada $f'(x) = -\dfrac{3x^2}{2} - \dfrac{1}{2}$. Temos que $x_1 = 0$ é ponto fixo, enquanto $x_2 = 1, x_3 = -1$ são pontos periódicos de período 2.
		\begin{itemize}
			\item $x_1$ é hiperbólico, pois $|f'(x_1)| = \dfrac{1}{2}$.
			\item $x_2$ é hiperbólico, pois $|f'(x_2)| = 2$.
			\item $x_3$ é hiperbólico, pois $|f'(x_3)| = 2$.
		\end{itemize}
	\end{exemplo}
