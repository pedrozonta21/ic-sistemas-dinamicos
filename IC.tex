...
\begin{document} 
	...
	Em seguida, aprofundaremos a análise do conceito de caos segundo a definição de Devaney, caracterizado por três pilares fundamentais: a dependência sensível às condições iniciais, a transitividade topológica e a densidade dos pontos periódicos. Para facilitar esse estudo, utilizaremos ferramentas de conjugação e semi-conjugação topológica, permitindo relacionar sistemas com modelos mais viáveis de se estudar.
	
	{\LARGE\textbf{Introdução}}
	
	O estudo dos sistemas dinâmicos é fundamental para compreender como diferentes populações evoluem ao longo do tempo, sendo elas modeladas por uma função que rege o seu desenvolvimento. A análise inicial de um sistema desse tipo consiste em investigar o comportamento assintótico de sua função, o que permite prever e descrever o destino das órbitas iteradas e a estabilidade de seus pontos. Algumas funções demonstram que pequenas variações em constantes ou entradas podem gerar resultados de extrema imprevisibilidade.
	...
	Para garantir a validade formal desse modelo, o projeto utiliza os conceitos de semi-conjugação e conjugação topológica. O trabalho demonstra a existência de um homeomorfismo entre o espaço do conjunto de Cantor $\Lambda$ e o espaço de sequências $\Sigma_2$ por meio da aplicação de itinerário e da utilização do mapa \textit{shift}. Essa equivalência topológica preserva propriedades entre os mapas conjugados e permite uma análise do caos. Apoiados na definição de Devaney, concluímos que o mapa logístico exibe comportamento caótico, o qual se baseia em três pilares essenciais: a dependência sensível às condições iniciais, a transitividade topológica e a densidade dos pontos periódicos.
