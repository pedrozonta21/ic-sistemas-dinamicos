...
Como $f: \mathbb{R} \rightarrow \mathbb{R}$, precisamos garantir $\mu$ tal que a raiz seja real. $1-4\mu \geq 0 \implies \mu \leq \dfrac{1}{4}$.
		...
		\noindent No entanto, quando $\mu < -\dfrac{3}{4}$, acontece uma mudança em $x_2$. Ao analisar $|f_\mu'(x)|$, temos
	...
	\begin{exemplo}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot [black, dashed, forget plot, opacity=0.5] coordinates {(-0.75, -1.6) (-0.75, -0.5)};
				\addplot [black, dashed, forget plot, opacity=0.5] coordinates {(0.25, -1.6) (0.25, 0.5)};
