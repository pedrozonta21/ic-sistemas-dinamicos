...
\begin{document} 
	...
	\begin{exemplo}
		Seja $f(x) = x^3$. Temos que os pontos no intervalo aberto $-1 < x < 1$ convergem para o ponto fixo $x = 0$, conforme tomamos uma condição inicial $x_0$ nesse intervalo, pois $|f^i(x_0) - f^i(0)| \rightarrow 0, i \rightarrow \infty$.
		
		---melhorar
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.65\textwidth]{imagens/desenho_orbita.png}
