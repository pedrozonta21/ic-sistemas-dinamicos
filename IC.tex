...
\begin{document} 
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\textwidth]{imagens/desenho_familia_quadratica_com_parametro.png}
...
Como $f: \mathbb{R} \rightarrow \mathbb{R}$, precisamos garantir $\mu$ tal que a raiz seja real. $1-4\mu \geq 0 \implies \mu \leq \dfrac{1}{4}$.
		\begin{itemize}
			...
			Para o ponto fixo $x=\dfrac{1}{2}$, temos que ele é não-hiperbólico, pois $f_\mu'\left(\dfrac{1}{2}\right)=1$. Logo, temos uma bifurcação nesse ponto.
			\item $\mu < \dfrac{1}{4}$:
