...
\begin{document} 
	...
	\begin{definicao}
		Um sistema dinâmico é definido por (X, f), onde X é um espaço métrico que possui todas as possibilidades de estado do sistema. Sistema esse que é regrado por uma função $f: \mathbb{X} \rightarrow \mathbb{X}$.
	\end{definicao}
