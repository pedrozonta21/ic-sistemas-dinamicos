...
Como $f: \mathbb{R} \rightarrow \mathbb{R}$, precisamos garantir $\mu$ tal que a raiz seja real. $1-4\mu \geq 0 \implies \mu \leq \dfrac{1}{4}$.
	...
	\begin{exemplo}
		...
		\begin{itemize}
			...
			Temos que $x_1 = x_2 = -\dfrac{1}{2}$, portanto, um ponto periódico apenas. Para esse ponto, temos que sua classificação é de ponto de sela, indicando uma bifurcação, pois $|(f_\mu^2)'(-\dfrac{1}{2}, -\dfrac{3}{4})| = 1$.
